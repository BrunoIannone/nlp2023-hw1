...
class BioDataset(Dataset):
    ...
    def __init__(self, sentences: List[str], labels: List[str], word_to_ix:dict,tag_to_ix:dict,transform=None, target_transform=None):
    ...
    def __getitem__(self, index:int):
        ...
        res = utils.sentence_to_idx(self.word_to_ix,sentence), utils.label_to_idx(self.tag_to_ix,labels)
